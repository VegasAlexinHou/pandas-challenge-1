...
Import the data from the CSV file.
        df = pd.read_csv('client_dataset.csv') Not in a Resource folder
...
Use the new columns with confirmed values to find the following information.
        ...
        keep getting errors in renaming
        resolve with the renaming first and then continue 
...
Write a brief 2-3 sentence summary of your findings.
   NOTES: The top 5 clients, identified by quantity, contributed significantly to the overall revenue and profit. The total revenue generated by these clients ranges in the millions, with total profits also reflecting substantial values. This analysis highlights the critical role of these key clients in the business's financial performance.
